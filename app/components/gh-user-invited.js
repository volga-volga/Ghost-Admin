        ...
        resend() {
            ...
            invite.resend().then((result) => {
                ...
                if (result.invites[0].status === 'invited-pending') {
                    notifications.showAlert('Письмо с приглашением не было отправлено. Пожалуйста, попробуйте отправить повторно.', {type: 'error', key: 'invite.resend.not-sent'});
                } else {
        ...
        revoke() {
            ...
            invite.reload().then(() => {
                ...
                if (isNotFoundError(error)) {
                    ...
                    notifications.showAlert('Это приглашение было отозвано, либо же пользователь уже принял приглашение.', {type: 'error', delayed: true, key: 'invite.revoke.already-accepted'});
                } else {
                    throw error;
                }
            });
